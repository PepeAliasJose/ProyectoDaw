...
VirtualSky.prototype.createSky = function(){
	...
	if(this.q.debug) S('body').append('<div style="position: absolute;bottom:0px;right:0px;padding: 0.25em 0.5em;background-color:#202028;color:black;max-width: 50%;" id="debug"></div>');
